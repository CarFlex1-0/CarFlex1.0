...
export function Effects() {
    ...
    const texture = useLoader(LUTCubeLoader, "../../../public/assets/models/F-6800-STD.cube", (loader) => {
        loader.load(
          "../../../public/assets/models/F-6800-STD.cube",
          (texture) => { console.log("successful cube load") },
          undefined,
          (error) => { console.error("Error loading LUT:", error); }
        );
      });
