...
const FeedbackForm = () => {
  ...
  return (
    <div>
      <h1 className="prose text-4xl mb-4 text-indigo-600 transition-transform duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:text-blue-400">
        Your Feedback Matters
      </h1>
      <div className="h-[50vh] flex flex-col items-stretch  mx-auto p-8 bg-white rounded-lg shadow-lg max-w-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div>
            ...
            <textarea
              ...
              } rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 text-gray-900 p-3 max-h-28`}
            ></textarea>
            {errors.content && (
